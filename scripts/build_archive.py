...
HERO_IMAGE_HEIGHT = 240
HERO_IMAGE_SIZES = "(max-width: 1212px) calc(100vw - 32px), 1180px"
HERO_IMAGE_JPGS = {
    1200: "/assets/images/hero-banner-1200.jpg",
    1800: "/assets/images/hero-banner-1800.jpg",
...
def hero_image_srcset(prefix: str, variants: dict[int, str]) -> str:
    return ", ".join(
        f"{prefix}{path.lstrip('/')} {width}w"
        for width, path in sorted(variants.items())
    )
