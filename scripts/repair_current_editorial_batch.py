...
GENERIC_HEADING_PATTERNS = [
    ...
    re.compile(r"^The dialogue matters because it tests .+ in public\.?$", re.I),
    re.compile(r"^The best persuasion shows .+\.?$", re.I),
]
...
GENERATED_GENERIC_PATTERNS = [
    ...
    re.compile(r"^The question matters because it changes what the reader would now compare, doubt, or investigate about .+$", re.I),
    re.compile(r"^The payoff here is practical\. A concrete case should make .+$", re.I),
    re.compile(r"^The pressure point is whether .+ survives the strongest reasonable objection rather than only sounding plausible in isolation\.$", re.I),
    re.compile(r"^The section works only if the reader can see how .+ connect, compete, or depend on one another rather than collapsing into one blurred inventory\.$", re.I),
    re.compile(r"^The section should clarify how .+ is being used, where it separates from nearby ideas, and why the sharper boundary matters in practice\.$", re.I),
    re.compile(r"^A likely objection is that the ordinary way of talking about .+ is already good enough\..+$", re.I),
...
def derive_heading_from_prompt(prompt: str, page_title: str) -> str:
    ...
    exact_overrides = {
        ...
        "what has the decrease in participation in regular religious meetings had on notions of god and spirituality?": "How declining religious attendance reshapes ideas of God",
        "what have been the historical markers of a religion headed for extinction?": "How religions usually look when they are fading out",
        "what cultural and societal traits correlate with high degrees of religiosity today?": "What present-day societies with strong religiosity tend to share",
        "what are the best online sources of philosophical training for those new to philosophy?": "The best online starting points for learning philosophy",
        "what are the best online resources of philosophical training for those new to philosophy?": "The best online starting points for learning philosophy",
        "what relationships exist among the different notions of impossibility?": "How the different kinds of impossibility relate",
        "what common erroneous conceptualizations of quantum physics contribute to the notion that quantum mechanics establishes something spiritual?": "Common mistakes that make quantum mechanics sound spiritual",
        "what common erroneous conceptualizations of quantum physics contribute to the notion": "Common mistakes that make quantum mechanics sound spiritual",
        "what is a strong argument in response to someone claiming the observation effect demonstrates our souls are interacting with matter?": "Why the observer effect does not show souls interacting with matter",
        "what are the common arguments in defense of the notion that mind is more fundamental than matter?": "The main arguments for mind-first metaphysics",
        "expand on the most common arguments invoked in defense of the notion that mind is fundamental": "The main arguments for mind-first metaphysics",
        "what are the common arguments against the notion that mind is more fundamental than matter?": "The main arguments against mind-first metaphysics",
        "expand on the most common arguments invoked in opposition to the notion that mind is fundamental": "The main arguments against mind-first metaphysics",
        "what are the most powerful concepts that have emerged from complexity theory research?": "The strongest ideas complexity theory has contributed",
        "what recent complexity theory research projects have shown promise?": "Promising recent directions in complexity theory",
        "what are the main domains of aesthetics?": "The main domains of aesthetics",
        "recommendations on a healthy amount of time a well-rounded mind might spend on various domains of aesthetics.": "How much attention a well-rounded life should give to different arts",
        ...
        "provide 5 examples of basic scientific tools and procedures being used in historical analyses.": "Five scientific tools historians use in practice",
        "provide 5 examples of basic scientific tools and procedures being use in historical analyses": "Five scientific tools historians use in practice",
